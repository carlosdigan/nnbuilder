...
export const LayerActivationFunction = memo(function LayerActivationFunction({ layer }: Props) {
...
function arePropsEqual(oldProps: Props, newProps: Props) {
 return oldProps.layer.activationFunction === newProps.layer.activationFunction 
}